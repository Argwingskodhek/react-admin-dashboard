...
const overviewData = [
  { name: "Revenue", value: "$5,234,567", change: 16.5, icon: DollarSign },
  { name: "Users", value: "45,678", change: 4.3, icon: Users },
  { name: "Orders", value: "9,876", change: -1.2, icon: ShoppingBag },
  { name: "Page Views", value: "2,234,567", change: 12.7, icon: Eye },
];
